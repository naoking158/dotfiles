...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
                         ...
                         KC_LSFT        , KC_Z    , KC_X         , KC_C         , KC_V       , KC_B       ,   KC_N          , KC_M           , KC_COMM , KC_DOT   , LT(3,KC_SLSH) , KC_BTN1  ,
                            LALT_T(KC_ESC)        , KC_LGUI , LT(2,KC_SPC) , LT(1,KC_SPC) , LALT(KC_X) ,                LT(1,KC_BSPC) , LT(2,KC_ENT) , _______ ,  _______ , KC_RALT
                         ),
  ...
  [1] = LAYOUT_universal(
                         ...
                         KC_LSFT         , _______    , KC_LEFT , KC_DOWN , KC_RIGHT  , RGUI(KC_RALT)     ,   _______      , _______       , _______    , _______      , KC_BACKSLASH   , _______          ,
                               LALT_T(KC_ESC)         , KC_LGUI    , _______ , _______ , _______   ,                       KC_BSPC      , RGUI_T(KC_ENT), _______    , _______      , KC_RALT
                         ),
  ...
  [2] = LAYOUT_universal(
                         ...
                         KC_LSFT        , _______ , _______ , _______ , _______ , _______        ,      KC_0     , KC_1, KC_2    , KC_3    , KC_PIPE            , _______              ,
                            LALT_T(KC_ESC)        , KC_LGUI , _______ , _______ , _______ ,                       KC_BSPC   , _______, _______ , _______ , _______
                         ),
