...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
                         ...
                         LALT(KC_X)     , KC_Z  , KC_X    , KC_C           , KC_V           , KC_B               ,   KC_N , KC_M           , KC_COMM      , KC_DOT  , LT(3,KC_SLSH) , KC_BTN1  ,
                                LALT_T(KC_ESC)  , KC_LGUI , LSFT_T(KC_SPC) , LGUI_T(KC_SPC) , LT(1, KC_BTN2)     ,           LT(2,KC_BSPC) , LT(1,KC_ENT) , _______ , _______       , KC_RALT
                         ),
  ...
  [1] = LAYOUT_universal(
                         ...
                         KC_LSFT         , _______    , KC_LEFT , KC_DOWN        , KC_RIGHT       , RGUI(KC_RALT)      ,   _______      , _______       , _______    , KC_BTN2      , KC_BACKSLASH   , KC_BTN1          ,
                                      LALT_T(KC_ESC)  , KC_LGUI , LSFT_T(KC_SPC) , LGUI_T(KC_SPC) , LT(1, KC_BTN2)     ,                    LT(2,KC_BSPC) , LT(1,KC_ENT) , _______    , _______      , KC_RALT
                         ),
  ...
  [2] = LAYOUT_universal(
                         ...
                         KC_LSFT        , _______ , _______ , _______ , _______ , _______        ,      KC_0     , KC_1, KC_2    , KC_3    , KC_PIPE            , _______              ,
                                LALT_T(KC_ESC)    , KC_LGUI , LSFT_T(KC_SPC) , LGUI_T(KC_SPC) ,  LT(1, KC_BTN2) ,                       KC_BSPC   , _______, _______ , _______ , _______
                         ),
  ...
  [3] = LAYOUT_universal(
                         ...
                         KC_LSFT        , _______ , KC_LEFT , KC_DOWN , KC_RIGHT , _______ ,            _______ , _______        , KC_BTN4 , KC_BTN5 , _______ , KC_BTN2 ,
                            LALT_T(KC_ESC)        , KC_LGUI , _______ , _______ , _______  ,                      KC_BSPC , RGUI_T(KC_ENT) , _______ , _______ , _______
                         ),
};
