...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_universal(
                         ...
                         LCTL_T(KC_ESC)   , _______ , _______ , _______ , KC_RGUI , RSG(KC_RCTL)   ,      KC_DOT   , KC_4, KC_5    , KC_6    , KC_LEFT_CURLY_BRACE, KC_RIGHT_CURLY_BRACE ,
                         KC_LSFT        , _______ , _______ , _______ , _______ , _______        ,      KC_0     , KC_1, KC_2    , KC_3    , KC_PIPE            , _______              ,
