...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
                         ...
                         KC_LSFT        , KC_Z  , KC_X    , KC_C           , KC_V           , KC_B                 ,           KC_N , KC_M           , KC_COMM      , KC_DOT  , LT(3,KC_SLSH) , KC_BTN1  ,
                                 LT(2,KC_BTN2)  , KC_LGUI , LSFT_T(KC_SPC) , LGUI_T(KC_SPC) , LALT_T(KC_ESC)       ,                   LT(2,KC_BSPC) , LT(1,KC_ENT) , _______ , _______       , KC_RALT
                         ),
  ...
  [2] = LAYOUT_universal(
                         ...
                         KC_LSFT  , _______ , _______ , _______        , _______        , _______                  ,        KC_0    , KC_1, KC_2    , KC_3    , KC_PIPE            , _______              ,
                             LT(2,KC_BTN2)  , KC_LGUI , LSFT_T(KC_SPC) , LGUI_T(KC_SPC) , LALT_T(KC_ESC)           ,                      KC_BSPC   , _______, _______ , _______ , _______
                         ),
