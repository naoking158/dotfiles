...
(leaf sql-indent
  :straight t
  :hook (go-ts-mode-hook . sqlind-minor-mode))
#+end_src
...
*** fussy
:PROPERTIES:
:ID:       45db9a8b-dd56-4638-9103-1152c9ffa825
:END:
...
(leaf ellama
  ...
  (setopt ellama-providers
            ...
            ("llama3" . (make-llm-ollama
                         :chat-model "llama3:8b-instruct-fp16"
                         :embedding-model "llama3:8b-instruct-fp16"))
            ("codestral" . (make-llm-ollama
                            :chat-model "codestral:22b"
                            :embedding-model "codestral:22b"))
            ))
  )
#+end_src
