...
alias pull='ssh vm3 "bash ~/work/VMOperateTool/utils/download.sh" && myrsync -d vm3 ~/work/VMOperateTool/ ~/src/work/VMOperateTool/'
alias push='myrsync -u vm3 ~/src/work/VMOperateTool/ ~/work/VMOperateTool/'
